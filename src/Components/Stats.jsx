...
const Stats = () => {
    return (
        <div className='flex flex-col md:flex-row gap-20 bg-gradient-to-r from-blue-700 to-purple-800 text-white px-80 py-14 my-6'>
            <div>
                <h2 className='font-bold text-2xl '>50K+</h2>
                <p className=' opacity-80'>Active User</p>
            </div>
                 <div className="hidden md:block w-[2px] h-10 bg-gray-300 opacity-40"></div>
